...
st.set_page_config(page_title="CatalogFix AI v1.8.13", page_icon="🧹", layout="wide")
st.title("CatalogFix AI v1.8.13")
...
st.download_button(
    ...
    excel_result,
    file_name="CatalogFix_Result_v1_8_13.xlsx",
...
st.download_button(
    ...
    file_name="Shopify_Ready_v1_8_13.csv",
    mime="text/csv",
