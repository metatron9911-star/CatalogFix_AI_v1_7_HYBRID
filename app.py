...
st.set_page_config(page_title=f"CatalogFix AI v{RELEASE_VERSION}", page_icon="🧹", layout="wide")
st.title(f"CatalogFix AI v{RELEASE_VERSION}")
...
st.download_button(
    ...
    excel_result,
    file_name=f"CatalogFix_Result_v{RELEASE_VERSION.replace('.', '_')}.xlsx",
...
st.download_button(
    ...
    file_name=f"Shopify_Ready_v{RELEASE_VERSION.replace('.', '_')}.csv",
    mime="text/csv",
